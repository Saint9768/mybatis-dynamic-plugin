...
public class MybatisPluginForTrace implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        try {
            ...
            if (Objects.equals(invocationName, MybatisPluginConst.METHOD_PREPARE.getVale())) {
                ...
                ParameterHandler handler = MyBatisPluginUtils.realTarget(invocation.getTarget());
                MetaObject metaObject = SystemMetaObject.forObject(handler);
    ...
    private void prepareUpdateSql(Statement statement, MetaObject metaObject) {
        ...
        for (int i = 0; i < update.getColumns().size(); i++) {
            ...
            if (column.getColumnName().equals(MybatisPluginConst.OPERATOR_ID_PROPERTY.getVale())) {
